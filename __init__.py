...
class Player(BasePlayer):
    ...
    #fin_roll_two = models.CurrencyField(label='What is the value of the second dice?', min=1, max=)
    #fin_roll_three = models.CurrencyField(label='What is the value of the third dice?', min=1, max=)
    #fin_roll_four = models.CurrencyField(label='What is the value of the fourth dice?', min=1, max=)
    #fin_roll_five = models.CurrencyField(label='What is the value of the fifth dice?', min=1, max=)
    acct_roll_one = models.CurrencyField(label='What is the value of the first dice?', min=1, max=)
    #acct_roll_two = models.CurrencyField(label='What is the value of the second dice?', min=1, max=)
    #acct_roll_three = models.CurrencyField(label='What is the value of the third dice?', min=1, max=)
    #acct_roll_four = models.CurrencyField(label='What is the value of the fourth dice?', min=1, max=)
    #acct_roll_five = models.CurrencyField(label='What is the value of the fifth dice?', min=1, max=)
